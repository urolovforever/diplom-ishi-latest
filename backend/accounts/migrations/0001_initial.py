...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(choices=[('super_admin', 'Super Admin'), ('qomita_rahbar', "Qo'mita Rahbari"), ('qomita_xodimi', "Qo'mita Xodimi"), ('konfessiya_rahbari', 'Konfessiya Rahbari'), ('konfessiya_xodimi', 'Konfessiya Xodimi'), ('dt_rahbar', 'Diniy Tashkilot Rahbari'), ('dt_xodimi', 'Diniy Tashkilot Xodimi')], max_length=50, unique=True)),
