        ...
        <div className="space-y-3">
          ...
          {list.length === 0 && (
            <div className="card p-12 text-center">
              ...
              <p className="text-text-secondary">{t('empty.no_notifications')}</p>
            </div>
          )}
          {count > 0 && (
            <p className="text-sm text-text-secondary text-center pt-2">{t('info.total_count', { count })}</p>
          )}
        </div>
      )}
    </div>
